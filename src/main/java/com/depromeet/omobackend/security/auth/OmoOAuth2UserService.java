 ...
 */
public class OmoOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    private static final Logger logger = LogManager.getLogger(OmoOAuth2UserService.class);
...
//        authorities.add(new SimpleGrantedAuthority(Role.USER.getKey()));
        ...
        String userEmailAttributeKey = OAuth2UserAttribute.USER_EMAIL;
        ...
        if (resourceServerUri != null && !"".equals(resourceServerUri) && accessToken != null && !"".equals(accessToken)) {
            ...
            try {
                ...
                String email = attributes.get("userEmail").toString();
        ...
        return new DefaultOAuth2User(Collections.singleton(
                new SimpleGrantedAuthority(Role.USER.getKey())), attributes, userEmailAttributeKey);
